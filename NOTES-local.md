...
**What is left, in order of what the evidence supports.** (1) Link jitter, still the ceiling and still only movable by Moonlight/host settings or step 8 — which no longer has lost presses as a justification. (2) The short-fit loss, real at 56% vs 91% but with its obvious fix now measured and rejected; the mechanism is unidentified. (3) Nothing else — the fit, the sleep, the lead and the freeze watch are all closed.
