...
Working: window targeting, focus gating, detection, key delivery through Moonlight, wiggle skill checks.

Not working: repair/heal land in **Good**, not **Great**.
...
| Live throughput | **34 fps** (README wants ~120) |
| Keypress → pixel round trip | **~72 ms** median |
